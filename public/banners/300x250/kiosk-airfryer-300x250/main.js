document.addEventListener("DOMContentLoaded", function (event) {
  ...
  // pexi.video(".kVideo", ["video.webm", "video.mp4"], {
  ...
  // var video = document.querySelector(".kVideo video");
  // video.loop = true;
  // video.repeat = true;
  
  // // Make sure video is properly sized and positioned
  ...
  // crossfade
    .to(".vrouw-copy-masked.B , .vrouw.B", {opacity:1, autoAlpha: 1, duration: 0.5 }, 1.8)
    .to(".vrouw-copy-masked.A , .vrouw.A", { autoAlpha: 0, duration: 0.5 },"<-.2")
