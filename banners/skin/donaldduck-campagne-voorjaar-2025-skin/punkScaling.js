...
function resizeContainer(oldValues, centerYOffset) {
    ...
    if(!containerTop.style.transform.includes('translate(calc(-50% + 27px), 0%)')){
        containerTop.style.transform += "translate(calc(-50% + 27px), 0%)"
    }
    if(!containerCenter.style.transform.includes('translate(calc(-50% + 27px), 0%)')){
        containerCenter.style.transform += "translate(calc(-50% + 27px), 0%)"
    }
    if(!containerBottom.style.transform.includes('translate(calc(-50% + 27px), 0%)')){
        containerBottom.style.transform += "translate(calc(-50% + 27px), 0%)"
    }
